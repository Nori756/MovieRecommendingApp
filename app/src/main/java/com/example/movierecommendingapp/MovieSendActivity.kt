...
class MovieSendActivity : AppCompatActivity(), View.OnClickListener, DatabaseReference.CompletionListener {
    companion object {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_movie_send)
    ...
    override fun onClick(v: View) {
        if (v === imageView) {
            ...
            if (body.isEmpty()) {
                ...
                Snackbar.make(v, "映画の概要を入力して下さい", Snackbar.LENGTH_LONG).show()
                return
            }
